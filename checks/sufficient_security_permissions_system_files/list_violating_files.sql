...
('1.5.1','/boot/grub/grub.cfg','0400','0','root',''),
...
('5.1.2','/etc/crontab','0600','0','root',''),
('5.1.3','/etc/cron.hourly','0700','0','root',''),
('5.1.4','/etc/cron.daily','0700','0','root',''),
('5.1.5','/etc/cron.weekly','0700','0','root',''),
('5.1.6','/etc/cron.monthly','0700','0','root',''),
('5.1.7','/etc/cron.d','0700','0','root',''),
('5.1.8','/etc/cron.allow','0640','0','root',''),
('5.1.8','/etc/at.allow','0640','0','root',''),
